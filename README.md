...
> Бляя, львиную доли времени занимает понять, как что либо вообще сделать. Порйо я вообще логику и алгоритм не понимаю и долго долго гуглю примеры. А бывает я начинаю чтото писать и потом через пару часов это улетает в stage, потому что хуйня вышла. 8-ой или 9-ый день, забыл. Ебаный Drag & Drop - но мне нужно разобраться как это работает.
